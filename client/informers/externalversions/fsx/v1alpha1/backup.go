	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.FsxV1alpha1().Backups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.FsxV1alpha1().Backups(namespace).Watch(context.TODO(), options)
			},
		},
		&fsxv1alpha1.Backup{},
		resyncPeriod,
...
func (f *backupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&fsxv1alpha1.Backup{}, f.defaultInformer)
}
