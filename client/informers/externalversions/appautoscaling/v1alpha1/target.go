	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AppautoscalingV1alpha1().Targets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AppautoscalingV1alpha1().Targets(namespace).Watch(context.TODO(), options)
			},
		},
		&appautoscalingv1alpha1.Target{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *targetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&appautoscalingv1alpha1.Target{}, f.defaultInformer)
}
