	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.LicensemanagerV1alpha1().Associations(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.LicensemanagerV1alpha1().Associations(namespace).Watch(context.TODO(), options)
			},
		},
		&licensemanagerv1alpha1.Association{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *associationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&licensemanagerv1alpha1.Association{}, f.defaultInformer)
}
