...
import (
	...
	v1alpha1 "kubeform.dev/provider-aws-api/client/listers/s3outposts/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.S3outpostsV1alpha1().Endpoints(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.S3outpostsV1alpha1().Endpoints(namespace).Watch(context.TODO(), options)
			},
		},
		&s3outpostsv1alpha1.Endpoint{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *endpointInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&s3outpostsv1alpha1.Endpoint{}, f.defaultInformer)
}
