	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DevicefarmV1alpha1().Uploads(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DevicefarmV1alpha1().Uploads(namespace).Watch(context.TODO(), options)
			},
		},
		&devicefarmv1alpha1.Upload{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *uploadInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&devicefarmv1alpha1.Upload{}, f.defaultInformer)
}
