	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudformationstackV1alpha1().CloudformationStacks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudformationstackV1alpha1().CloudformationStacks(namespace).Watch(context.TODO(), options)
			},
		},
		&cloudformationstackv1alpha1.CloudformationStack{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cloudformationStackInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudformationstackv1alpha1.CloudformationStack{}, f.defaultInformer)
}
