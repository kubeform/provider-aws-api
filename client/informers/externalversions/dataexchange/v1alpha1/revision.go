	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DataexchangeV1alpha1().Revisions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DataexchangeV1alpha1().Revisions(namespace).Watch(context.TODO(), options)
			},
		},
		&dataexchangev1alpha1.Revision{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *revisionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&dataexchangev1alpha1.Revision{}, f.defaultInformer)
}
