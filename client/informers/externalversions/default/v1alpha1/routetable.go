	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DefaultV1alpha1().RouteTables(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DefaultV1alpha1().RouteTables(namespace).Watch(context.TODO(), options)
			},
		},
		&defaultv1alpha1.RouteTable{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *routeTableInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&defaultv1alpha1.RouteTable{}, f.defaultInformer)
}
