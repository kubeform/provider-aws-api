...
// SourceCredentials returns a SourceCredentialInformer.
func (v *version) SourceCredentials() SourceCredentialInformer {
	return &sourceCredentialInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
