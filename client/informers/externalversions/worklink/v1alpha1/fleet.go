	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WorklinkV1alpha1().Fleets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WorklinkV1alpha1().Fleets(namespace).Watch(context.TODO(), options)
			},
		},
		&worklinkv1alpha1.Fleet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *fleetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&worklinkv1alpha1.Fleet{}, f.defaultInformer)
}
