	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Route53recoveryreadinessV1alpha1().Cells(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Route53recoveryreadinessV1alpha1().Cells(namespace).Watch(context.TODO(), options)
			},
		},
		&route53recoveryreadinessv1alpha1.Cell{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cellInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&route53recoveryreadinessv1alpha1.Cell{}, f.defaultInformer)
}
