...
// DomainPermissionsPolicies returns a DomainPermissionsPolicyInformer.
func (v *version) DomainPermissionsPolicies() DomainPermissionsPolicyInformer {
	return &domainPermissionsPolicyInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
...
// RepositoryPermissionsPolicies returns a RepositoryPermissionsPolicyInformer.
func (v *version) RepositoryPermissionsPolicies() RepositoryPermissionsPolicyInformer {
	return &repositoryPermissionsPolicyInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
