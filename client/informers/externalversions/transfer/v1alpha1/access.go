...
import (
	...
	v1alpha1 "kubeform.dev/provider-aws-api/client/listers/transfer/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TransferV1alpha1().Accesses(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TransferV1alpha1().Accesses(namespace).Watch(context.TODO(), options)
			},
		},
		&transferv1alpha1.Access{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *accessInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&transferv1alpha1.Access{}, f.defaultInformer)
}
