	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.TransferV1alpha1().SshKeys(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.TransferV1alpha1().SshKeys(namespace).Watch(context.TODO(), options)
			},
		},
		&transferv1alpha1.SshKey{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sshKeyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&transferv1alpha1.SshKey{}, f.defaultInformer)
}
