	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudtrailV1alpha1().Cloudtrails(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudtrailV1alpha1().Cloudtrails(namespace).Watch(context.TODO(), options)
			},
		},
		&cloudtrailv1alpha1.Cloudtrail{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cloudtrailInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudtrailv1alpha1.Cloudtrail{}, f.defaultInformer)
}
