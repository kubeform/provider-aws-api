	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EksV1alpha1().Addons(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EksV1alpha1().Addons(namespace).Watch(context.TODO(), options)
			},
		},
		&eksv1alpha1.Addon{},
		resyncPeriod,
...
func (f *addonInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&eksv1alpha1.Addon{}, f.defaultInformer)
}
