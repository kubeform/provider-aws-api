	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WafV1alpha1().RegexPatternSets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WafV1alpha1().RegexPatternSets(namespace).Watch(context.TODO(), options)
			},
		},
		&wafv1alpha1.RegexPatternSet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *regexPatternSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&wafv1alpha1.RegexPatternSet{}, f.defaultInformer)
}
