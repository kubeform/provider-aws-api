	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.WafV1alpha1().RuleGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WafV1alpha1().RuleGroups(namespace).Watch(context.TODO(), options)
			},
		},
		&wafv1alpha1.RuleGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *ruleGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&wafv1alpha1.RuleGroup{}, f.defaultInformer)
}
