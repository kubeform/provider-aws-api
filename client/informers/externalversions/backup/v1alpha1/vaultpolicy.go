	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BackupV1alpha1().VaultPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BackupV1alpha1().VaultPolicies(namespace).Watch(context.TODO(), options)
			},
		},
		&backupv1alpha1.VaultPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *vaultPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&backupv1alpha1.VaultPolicy{}, f.defaultInformer)
}
