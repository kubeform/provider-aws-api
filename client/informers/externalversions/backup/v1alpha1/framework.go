	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.BackupV1alpha1().Frameworks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BackupV1alpha1().Frameworks(namespace).Watch(context.TODO(), options)
			},
		},
		&backupv1alpha1.Framework{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *frameworkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&backupv1alpha1.Framework{}, f.defaultInformer)
}
