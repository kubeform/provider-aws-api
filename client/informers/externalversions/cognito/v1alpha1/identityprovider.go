	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CognitoV1alpha1().IdentityProviders(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CognitoV1alpha1().IdentityProviders(namespace).Watch(context.TODO(), options)
			},
		},
		&cognitov1alpha1.IdentityProvider{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *identityProviderInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cognitov1alpha1.IdentityProvider{}, f.defaultInformer)
}
