...
import (
	...
	v1alpha1 "kubeform.dev/provider-aws-api/client/listers/codestarconnections/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CodestarconnectionsV1alpha1().Connections(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CodestarconnectionsV1alpha1().Connections(namespace).Watch(context.TODO(), options)
			},
		},
		&codestarconnectionsv1alpha1.Connection{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *connectionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&codestarconnectionsv1alpha1.Connection{}, f.defaultInformer)
}
