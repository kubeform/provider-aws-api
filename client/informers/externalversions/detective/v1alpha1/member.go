	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DetectiveV1alpha1().Members(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DetectiveV1alpha1().Members(namespace).Watch(context.TODO(), options)
			},
		},
		&detectivev1alpha1.Member{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *memberInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&detectivev1alpha1.Member{}, f.defaultInformer)
}
