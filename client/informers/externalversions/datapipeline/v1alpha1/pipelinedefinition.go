...
import (
	...
	v1alpha1 "kubeform.dev/provider-aws-api/client/listers/datapipeline/v1alpha1"
...
type PipelineDefinitionInformer interface {
	...
	Lister() v1alpha1.PipelineDefinitionLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DatapipelineV1alpha1().PipelineDefinitions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DatapipelineV1alpha1().PipelineDefinitions(namespace).Watch(context.TODO(), options)
			},
		},
		&datapipelinev1alpha1.PipelineDefinition{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pipelineDefinitionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&datapipelinev1alpha1.PipelineDefinition{}, f.defaultInformer)
}

func (f *pipelineDefinitionInformer) Lister() v1alpha1.PipelineDefinitionLister {
	return v1alpha1.NewPipelineDefinitionLister(f.Informer().GetIndexer())
}
