...
import (
	...
	v1alpha1 "kubeform.dev/provider-aws-api/client/listers/codestarnotifications/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CodestarnotificationsV1alpha1().NotificationRules(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CodestarnotificationsV1alpha1().NotificationRules(namespace).Watch(context.TODO(), options)
			},
		},
		&codestarnotificationsv1alpha1.NotificationRule{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *notificationRuleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&codestarnotificationsv1alpha1.NotificationRule{}, f.defaultInformer)
}
