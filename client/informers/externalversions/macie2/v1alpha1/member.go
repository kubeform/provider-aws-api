	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Macie2V1alpha1().Members(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Macie2V1alpha1().Members(namespace).Watch(context.TODO(), options)
			},
		},
		&macie2v1alpha1.Member{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *memberInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&macie2v1alpha1.Member{}, f.defaultInformer)
}
