...
type ConstraintInformer interface {
	...
	Lister() v1alpha1.ConstraintLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ServicecatalogV1alpha1().Constraints(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ServicecatalogV1alpha1().Constraints(namespace).Watch(context.TODO(), options)
			},
		},
		&servicecatalogv1alpha1.Constraint{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *constraintInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&servicecatalogv1alpha1.Constraint{}, f.defaultInformer)
}

func (f *constraintInformer) Lister() v1alpha1.ConstraintLister {
	return v1alpha1.NewConstraintLister(f.Informer().GetIndexer())
}
