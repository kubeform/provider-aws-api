	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ImagebuilderV1alpha1().Components(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ImagebuilderV1alpha1().Components(namespace).Watch(context.TODO(), options)
			},
		},
		&imagebuilderv1alpha1.Component{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *componentInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&imagebuilderv1alpha1.Component{}, f.defaultInformer)
}
