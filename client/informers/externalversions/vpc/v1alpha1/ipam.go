	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VpcV1alpha1().Ipams(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VpcV1alpha1().Ipams(namespace).Watch(context.TODO(), options)
			},
		},
		&vpcv1alpha1.Ipam{},
		resyncPeriod,
...
func (f *ipamInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&vpcv1alpha1.Ipam{}, f.defaultInformer)
}

func (f *ipamInformer) Lister() v1alpha1.IpamLister {
	return v1alpha1.NewIpamLister(f.Informer().GetIndexer())
}
