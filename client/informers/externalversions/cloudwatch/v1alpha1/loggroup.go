	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CloudwatchV1alpha1().LogGroups(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CloudwatchV1alpha1().LogGroups(namespace).Watch(context.TODO(), options)
			},
		},
		&cloudwatchv1alpha1.LogGroup{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *logGroupInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&cloudwatchv1alpha1.LogGroup{}, f.defaultInformer)
}
