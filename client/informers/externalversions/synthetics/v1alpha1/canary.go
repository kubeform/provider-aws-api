...
import (
	...
	v1alpha1 "kubeform.dev/provider-aws-api/client/listers/synthetics/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SyntheticsV1alpha1().Canaries(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SyntheticsV1alpha1().Canaries(namespace).Watch(context.TODO(), options)
			},
		},
		&syntheticsv1alpha1.Canary{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *canaryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&syntheticsv1alpha1.Canary{}, f.defaultInformer)
}
