	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DatasyncV1alpha1().Tasks(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DatasyncV1alpha1().Tasks(namespace).Watch(context.TODO(), options)
			},
		},
		&datasyncv1alpha1.Task{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *taskInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&datasyncv1alpha1.Task{}, f.defaultInformer)
}
