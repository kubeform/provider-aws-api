	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CodecommitV1alpha1().Triggers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CodecommitV1alpha1().Triggers(namespace).Watch(context.TODO(), options)
			},
		},
		&codecommitv1alpha1.Trigger{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *triggerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&codecommitv1alpha1.Trigger{}, f.defaultInformer)
}
