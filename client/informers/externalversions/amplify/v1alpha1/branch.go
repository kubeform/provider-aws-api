	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.AmplifyV1alpha1().Branches(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.AmplifyV1alpha1().Branches(namespace).Watch(context.TODO(), options)
			},
		},
		&amplifyv1alpha1.Branch{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *branchInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&amplifyv1alpha1.Branch{}, f.defaultInformer)
}
