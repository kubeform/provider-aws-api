	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EcrpublicV1alpha1().RepositoryPolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EcrpublicV1alpha1().RepositoryPolicies(namespace).Watch(context.TODO(), options)
			},
		},
		&ecrpublicv1alpha1.RepositoryPolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *repositoryPolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ecrpublicv1alpha1.RepositoryPolicy{}, f.defaultInformer)
}
