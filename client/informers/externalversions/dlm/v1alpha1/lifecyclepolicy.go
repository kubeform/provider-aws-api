...
import (
	...
	v1alpha1 "kubeform.dev/provider-aws-api/client/listers/dlm/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.DlmV1alpha1().LifecyclePolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.DlmV1alpha1().LifecyclePolicies(namespace).Watch(context.TODO(), options)
			},
		},
