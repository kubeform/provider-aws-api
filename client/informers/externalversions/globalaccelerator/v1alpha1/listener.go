	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GlobalacceleratorV1alpha1().Listeners(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GlobalacceleratorV1alpha1().Listeners(namespace).Watch(context.TODO(), options)
			},
		},
		&globalacceleratorv1alpha1.Listener{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *listenerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&globalacceleratorv1alpha1.Listener{}, f.defaultInformer)
}
