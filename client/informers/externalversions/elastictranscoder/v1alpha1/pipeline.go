	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ElastictranscoderV1alpha1().Pipelines(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ElastictranscoderV1alpha1().Pipelines(namespace).Watch(context.TODO(), options)
			},
		},
		&elastictranscoderv1alpha1.Pipeline{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *pipelineInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&elastictranscoderv1alpha1.Pipeline{}, f.defaultInformer)
}
