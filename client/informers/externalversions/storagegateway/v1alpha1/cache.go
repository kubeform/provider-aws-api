	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.StoragegatewayV1alpha1().Caches(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.StoragegatewayV1alpha1().Caches(namespace).Watch(context.TODO(), options)
			},
		},
		&storagegatewayv1alpha1.Cache{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *cacheInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&storagegatewayv1alpha1.Cache{}, f.defaultInformer)
}
