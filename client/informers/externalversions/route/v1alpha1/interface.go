...
type Interface interface {
	...
	// TableAssociations returns a TableAssociationInformer.
	TableAssociations() TableAssociationInformer
}
...
// TableAssociations returns a TableAssociationInformer.
func (v *version) TableAssociations() TableAssociationInformer {
	return &tableAssociationInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
