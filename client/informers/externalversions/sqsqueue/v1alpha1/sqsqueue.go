...
import (
	...
	v1alpha1 "kubeform.dev/provider-aws-api/client/listers/sqsqueue/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SqsqueueV1alpha1().SqsQueues(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SqsqueueV1alpha1().SqsQueues(namespace).Watch(context.TODO(), options)
			},
		},
		&sqsqueuev1alpha1.SqsQueue{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *sqsQueueInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&sqsqueuev1alpha1.SqsQueue{}, f.defaultInformer)
}
