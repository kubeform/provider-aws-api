	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.S3V1alpha1().BucketACLs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.S3V1alpha1().BucketACLs(namespace).Watch(context.TODO(), options)
			},
		},
		&s3v1alpha1.BucketACL{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *bucketACLInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&s3v1alpha1.BucketACL{}, f.defaultInformer)
}
