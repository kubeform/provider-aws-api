	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.EcrV1alpha1().LifecyclePolicies(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EcrV1alpha1().LifecyclePolicies(namespace).Watch(context.TODO(), options)
			},
		},
		&ecrv1alpha1.LifecyclePolicy{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *lifecyclePolicyInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ecrv1alpha1.LifecyclePolicy{}, f.defaultInformer)
}
