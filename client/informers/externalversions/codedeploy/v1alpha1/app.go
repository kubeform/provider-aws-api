...
import (
	...
	v1alpha1 "kubeform.dev/provider-aws-api/client/listers/codedeploy/v1alpha1"
)
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CodedeployV1alpha1().Apps(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CodedeployV1alpha1().Apps(namespace).Watch(context.TODO(), options)
			},
		},
		&codedeployv1alpha1.App{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *appInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&codedeployv1alpha1.App{}, f.defaultInformer)
}
