	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Wafv2V1alpha1().WebACLs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Wafv2V1alpha1().WebACLs(namespace).Watch(context.TODO(), options)
			},
		},
		&wafv2v1alpha1.WebACL{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *webACLInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&wafv2v1alpha1.WebACL{}, f.defaultInformer)
}
