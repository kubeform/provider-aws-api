	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Wafv2V1alpha1().RegexPatternSets(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Wafv2V1alpha1().RegexPatternSets(namespace).Watch(context.TODO(), options)
			},
		},
		&wafv2v1alpha1.RegexPatternSet{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *regexPatternSetInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&wafv2v1alpha1.RegexPatternSet{}, f.defaultInformer)
}
