	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Route53V1alpha1().ResolverEndpoints(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Route53V1alpha1().ResolverEndpoints(namespace).Watch(context.TODO(), options)
			},
		},
		&route53v1alpha1.ResolverEndpoint{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *resolverEndpointInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&route53v1alpha1.ResolverEndpoint{}, f.defaultInformer)
}
