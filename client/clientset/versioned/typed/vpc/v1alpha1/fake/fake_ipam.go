...
var ipamsResource = schema.GroupVersionResource{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Resource: "ipams"}

var ipamsKind = schema.GroupVersionKind{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Kind: "Ipam"}
...
func (c *FakeIpams) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Ipam, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(ipamsResource, c.ns, name), &v1alpha1.Ipam{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Ipam), err
}
...
func (c *FakeIpams) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IpamList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(ipamsResource, ipamsKind, c.ns, opts), &v1alpha1.IpamList{})
	...
	list := &v1alpha1.IpamList{ListMeta: obj.(*v1alpha1.IpamList).ListMeta}
	for _, item := range obj.(*v1alpha1.IpamList).Items {
...
func (c *FakeIpams) Create(ctx context.Context, ipam *v1alpha1.Ipam, opts v1.CreateOptions) (result *v1alpha1.Ipam, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(ipamsResource, c.ns, ipam), &v1alpha1.Ipam{})
...
func (c *FakeIpams) Update(ctx context.Context, ipam *v1alpha1.Ipam, opts v1.UpdateOptions) (result *v1alpha1.Ipam, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(ipamsResource, c.ns, ipam), &v1alpha1.Ipam{})
...
func (c *FakeIpams) UpdateStatus(ctx context.Context, ipam *v1alpha1.Ipam, opts v1.UpdateOptions) (*v1alpha1.Ipam, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(ipamsResource, "status", c.ns, ipam), &v1alpha1.Ipam{})
...
func (c *FakeIpams) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(ipamsResource, c.ns, name), &v1alpha1.Ipam{})
...
func (c *FakeIpams) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.IpamList{})
	return err
}
...
func (c *FakeIpams) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Ipam, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(ipamsResource, c.ns, name, pt, data, subresources...), &v1alpha1.Ipam{})
