...
var ipampoolcidrallocationsResource = schema.GroupVersionResource{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Resource: "ipampoolcidrallocations"}

var ipampoolcidrallocationsKind = schema.GroupVersionKind{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Kind: "IpamPoolCIDRAllocation"}
...
func (c *FakeIpamPoolCIDRAllocations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IpamPoolCIDRAllocation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(ipampoolcidrallocationsResource, c.ns, name), &v1alpha1.IpamPoolCIDRAllocation{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IpamPoolCIDRAllocation), err
}
...
func (c *FakeIpamPoolCIDRAllocations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IpamPoolCIDRAllocationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(ipampoolcidrallocationsResource, ipampoolcidrallocationsKind, c.ns, opts), &v1alpha1.IpamPoolCIDRAllocationList{})
	...
	list := &v1alpha1.IpamPoolCIDRAllocationList{ListMeta: obj.(*v1alpha1.IpamPoolCIDRAllocationList).ListMeta}
	for _, item := range obj.(*v1alpha1.IpamPoolCIDRAllocationList).Items {
...
func (c *FakeIpamPoolCIDRAllocations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(ipampoolcidrallocationsResource, c.ns, opts))
...
func (c *FakeIpamPoolCIDRAllocations) Create(ctx context.Context, ipamPoolCIDRAllocation *v1alpha1.IpamPoolCIDRAllocation, opts v1.CreateOptions) (result *v1alpha1.IpamPoolCIDRAllocation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(ipampoolcidrallocationsResource, c.ns, ipamPoolCIDRAllocation), &v1alpha1.IpamPoolCIDRAllocation{})
...
func (c *FakeIpamPoolCIDRAllocations) Update(ctx context.Context, ipamPoolCIDRAllocation *v1alpha1.IpamPoolCIDRAllocation, opts v1.UpdateOptions) (result *v1alpha1.IpamPoolCIDRAllocation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(ipampoolcidrallocationsResource, c.ns, ipamPoolCIDRAllocation), &v1alpha1.IpamPoolCIDRAllocation{})
...
func (c *FakeIpamPoolCIDRAllocations) UpdateStatus(ctx context.Context, ipamPoolCIDRAllocation *v1alpha1.IpamPoolCIDRAllocation, opts v1.UpdateOptions) (*v1alpha1.IpamPoolCIDRAllocation, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(ipampoolcidrallocationsResource, "status", c.ns, ipamPoolCIDRAllocation), &v1alpha1.IpamPoolCIDRAllocation{})
...
func (c *FakeIpamPoolCIDRAllocations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(ipampoolcidrallocationsResource, c.ns, name), &v1alpha1.IpamPoolCIDRAllocation{})
...
func (c *FakeIpamPoolCIDRAllocations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(ipampoolcidrallocationsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.IpamPoolCIDRAllocationList{})
	return err
}
...
func (c *FakeIpamPoolCIDRAllocations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IpamPoolCIDRAllocation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(ipampoolcidrallocationsResource, c.ns, name, pt, data, subresources...), &v1alpha1.IpamPoolCIDRAllocation{})
