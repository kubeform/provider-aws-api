...
var dhcpoptionsassociationsResource = schema.GroupVersionResource{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Resource: "dhcpoptionsassociations"}

var dhcpoptionsassociationsKind = schema.GroupVersionKind{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Kind: "DhcpOptionsAssociation"}
...
func (c *FakeDhcpOptionsAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.DhcpOptionsAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(dhcpoptionsassociationsResource, c.ns, name), &v1alpha1.DhcpOptionsAssociation{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.DhcpOptionsAssociation), err
}
...
func (c *FakeDhcpOptionsAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.DhcpOptionsAssociationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(dhcpoptionsassociationsResource, dhcpoptionsassociationsKind, c.ns, opts), &v1alpha1.DhcpOptionsAssociationList{})
	...
	list := &v1alpha1.DhcpOptionsAssociationList{ListMeta: obj.(*v1alpha1.DhcpOptionsAssociationList).ListMeta}
	for _, item := range obj.(*v1alpha1.DhcpOptionsAssociationList).Items {
...
func (c *FakeDhcpOptionsAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(dhcpoptionsassociationsResource, c.ns, opts))
...
func (c *FakeDhcpOptionsAssociations) Create(ctx context.Context, dhcpOptionsAssociation *v1alpha1.DhcpOptionsAssociation, opts v1.CreateOptions) (result *v1alpha1.DhcpOptionsAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(dhcpoptionsassociationsResource, c.ns, dhcpOptionsAssociation), &v1alpha1.DhcpOptionsAssociation{})
...
func (c *FakeDhcpOptionsAssociations) Update(ctx context.Context, dhcpOptionsAssociation *v1alpha1.DhcpOptionsAssociation, opts v1.UpdateOptions) (result *v1alpha1.DhcpOptionsAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(dhcpoptionsassociationsResource, c.ns, dhcpOptionsAssociation), &v1alpha1.DhcpOptionsAssociation{})
...
func (c *FakeDhcpOptionsAssociations) UpdateStatus(ctx context.Context, dhcpOptionsAssociation *v1alpha1.DhcpOptionsAssociation, opts v1.UpdateOptions) (*v1alpha1.DhcpOptionsAssociation, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(dhcpoptionsassociationsResource, "status", c.ns, dhcpOptionsAssociation), &v1alpha1.DhcpOptionsAssociation{})
...
func (c *FakeDhcpOptionsAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(dhcpoptionsassociationsResource, c.ns, name), &v1alpha1.DhcpOptionsAssociation{})
...
func (c *FakeDhcpOptionsAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(dhcpoptionsassociationsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.DhcpOptionsAssociationList{})
	return err
}
...
func (c *FakeDhcpOptionsAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.DhcpOptionsAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(dhcpoptionsassociationsResource, c.ns, name, pt, data, subresources...), &v1alpha1.DhcpOptionsAssociation{})
