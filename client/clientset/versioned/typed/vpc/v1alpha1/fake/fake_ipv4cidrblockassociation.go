...
var ipv4cidrblockassociationsResource = schema.GroupVersionResource{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Resource: "ipv4cidrblockassociations"}

var ipv4cidrblockassociationsKind = schema.GroupVersionKind{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Kind: "Ipv4CIDRBlockAssociation"}
...
func (c *FakeIpv4CIDRBlockAssociations) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Ipv4CIDRBlockAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(ipv4cidrblockassociationsResource, c.ns, name), &v1alpha1.Ipv4CIDRBlockAssociation{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.Ipv4CIDRBlockAssociation), err
}
...
func (c *FakeIpv4CIDRBlockAssociations) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.Ipv4CIDRBlockAssociationList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(ipv4cidrblockassociationsResource, ipv4cidrblockassociationsKind, c.ns, opts), &v1alpha1.Ipv4CIDRBlockAssociationList{})
	...
	list := &v1alpha1.Ipv4CIDRBlockAssociationList{ListMeta: obj.(*v1alpha1.Ipv4CIDRBlockAssociationList).ListMeta}
	for _, item := range obj.(*v1alpha1.Ipv4CIDRBlockAssociationList).Items {
...
func (c *FakeIpv4CIDRBlockAssociations) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(ipv4cidrblockassociationsResource, c.ns, opts))
...
func (c *FakeIpv4CIDRBlockAssociations) Create(ctx context.Context, ipv4CIDRBlockAssociation *v1alpha1.Ipv4CIDRBlockAssociation, opts v1.CreateOptions) (result *v1alpha1.Ipv4CIDRBlockAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(ipv4cidrblockassociationsResource, c.ns, ipv4CIDRBlockAssociation), &v1alpha1.Ipv4CIDRBlockAssociation{})
...
func (c *FakeIpv4CIDRBlockAssociations) Update(ctx context.Context, ipv4CIDRBlockAssociation *v1alpha1.Ipv4CIDRBlockAssociation, opts v1.UpdateOptions) (result *v1alpha1.Ipv4CIDRBlockAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(ipv4cidrblockassociationsResource, c.ns, ipv4CIDRBlockAssociation), &v1alpha1.Ipv4CIDRBlockAssociation{})
...
func (c *FakeIpv4CIDRBlockAssociations) UpdateStatus(ctx context.Context, ipv4CIDRBlockAssociation *v1alpha1.Ipv4CIDRBlockAssociation, opts v1.UpdateOptions) (*v1alpha1.Ipv4CIDRBlockAssociation, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(ipv4cidrblockassociationsResource, "status", c.ns, ipv4CIDRBlockAssociation), &v1alpha1.Ipv4CIDRBlockAssociation{})
...
func (c *FakeIpv4CIDRBlockAssociations) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(ipv4cidrblockassociationsResource, c.ns, name), &v1alpha1.Ipv4CIDRBlockAssociation{})
...
func (c *FakeIpv4CIDRBlockAssociations) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(ipv4cidrblockassociationsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.Ipv4CIDRBlockAssociationList{})
	return err
}
...
func (c *FakeIpv4CIDRBlockAssociations) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Ipv4CIDRBlockAssociation, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(ipv4cidrblockassociationsResource, c.ns, name, pt, data, subresources...), &v1alpha1.Ipv4CIDRBlockAssociation{})
