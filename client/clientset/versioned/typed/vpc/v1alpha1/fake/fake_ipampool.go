...
var ipampoolsResource = schema.GroupVersionResource{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Resource: "ipampools"}

var ipampoolsKind = schema.GroupVersionKind{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Kind: "IpamPool"}
...
func (c *FakeIpamPools) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IpamPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(ipampoolsResource, c.ns, name), &v1alpha1.IpamPool{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IpamPool), err
}
...
func (c *FakeIpamPools) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IpamPoolList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(ipampoolsResource, ipampoolsKind, c.ns, opts), &v1alpha1.IpamPoolList{})
	...
	list := &v1alpha1.IpamPoolList{ListMeta: obj.(*v1alpha1.IpamPoolList).ListMeta}
	for _, item := range obj.(*v1alpha1.IpamPoolList).Items {
...
func (c *FakeIpamPools) Create(ctx context.Context, ipamPool *v1alpha1.IpamPool, opts v1.CreateOptions) (result *v1alpha1.IpamPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(ipampoolsResource, c.ns, ipamPool), &v1alpha1.IpamPool{})
...
func (c *FakeIpamPools) Update(ctx context.Context, ipamPool *v1alpha1.IpamPool, opts v1.UpdateOptions) (result *v1alpha1.IpamPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(ipampoolsResource, c.ns, ipamPool), &v1alpha1.IpamPool{})
...
func (c *FakeIpamPools) UpdateStatus(ctx context.Context, ipamPool *v1alpha1.IpamPool, opts v1.UpdateOptions) (*v1alpha1.IpamPool, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(ipampoolsResource, "status", c.ns, ipamPool), &v1alpha1.IpamPool{})
...
func (c *FakeIpamPools) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(ipampoolsResource, c.ns, name), &v1alpha1.IpamPool{})
...
func (c *FakeIpamPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha1.IpamPoolList{})
	return err
}
...
func (c *FakeIpamPools) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IpamPool, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(ipampoolsResource, c.ns, name, pt, data, subresources...), &v1alpha1.IpamPool{})
