...
var ipampreviewnextcidrsResource = schema.GroupVersionResource{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Resource: "ipampreviewnextcidrs"}

var ipampreviewnextcidrsKind = schema.GroupVersionKind{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Kind: "IpamPreviewNextCIDR"}
...
func (c *FakeIpamPreviewNextCIDRs) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.IpamPreviewNextCIDR, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(ipampreviewnextcidrsResource, c.ns, name), &v1alpha1.IpamPreviewNextCIDR{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.IpamPreviewNextCIDR), err
}
...
func (c *FakeIpamPreviewNextCIDRs) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.IpamPreviewNextCIDRList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(ipampreviewnextcidrsResource, ipampreviewnextcidrsKind, c.ns, opts), &v1alpha1.IpamPreviewNextCIDRList{})
	...
	list := &v1alpha1.IpamPreviewNextCIDRList{ListMeta: obj.(*v1alpha1.IpamPreviewNextCIDRList).ListMeta}
	for _, item := range obj.(*v1alpha1.IpamPreviewNextCIDRList).Items {
...
func (c *FakeIpamPreviewNextCIDRs) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(ipampreviewnextcidrsResource, c.ns, opts))
...
func (c *FakeIpamPreviewNextCIDRs) Create(ctx context.Context, ipamPreviewNextCIDR *v1alpha1.IpamPreviewNextCIDR, opts v1.CreateOptions) (result *v1alpha1.IpamPreviewNextCIDR, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(ipampreviewnextcidrsResource, c.ns, ipamPreviewNextCIDR), &v1alpha1.IpamPreviewNextCIDR{})
...
func (c *FakeIpamPreviewNextCIDRs) Update(ctx context.Context, ipamPreviewNextCIDR *v1alpha1.IpamPreviewNextCIDR, opts v1.UpdateOptions) (result *v1alpha1.IpamPreviewNextCIDR, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(ipampreviewnextcidrsResource, c.ns, ipamPreviewNextCIDR), &v1alpha1.IpamPreviewNextCIDR{})
...
func (c *FakeIpamPreviewNextCIDRs) UpdateStatus(ctx context.Context, ipamPreviewNextCIDR *v1alpha1.IpamPreviewNextCIDR, opts v1.UpdateOptions) (*v1alpha1.IpamPreviewNextCIDR, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(ipampreviewnextcidrsResource, "status", c.ns, ipamPreviewNextCIDR), &v1alpha1.IpamPreviewNextCIDR{})
...
func (c *FakeIpamPreviewNextCIDRs) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(ipampreviewnextcidrsResource, c.ns, name), &v1alpha1.IpamPreviewNextCIDR{})
...
func (c *FakeIpamPreviewNextCIDRs) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(ipampreviewnextcidrsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.IpamPreviewNextCIDRList{})
	return err
}
...
func (c *FakeIpamPreviewNextCIDRs) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.IpamPreviewNextCIDR, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(ipampreviewnextcidrsResource, c.ns, name, pt, data, subresources...), &v1alpha1.IpamPreviewNextCIDR{})
