...
var endpointpoliciesResource = schema.GroupVersionResource{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Resource: "endpointpolicies"}

var endpointpoliciesKind = schema.GroupVersionKind{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Kind: "EndpointPolicy"}
...
func (c *FakeEndpointPolicies) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EndpointPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(endpointpoliciesResource, c.ns, name), &v1alpha1.EndpointPolicy{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EndpointPolicy), err
}
...
func (c *FakeEndpointPolicies) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EndpointPolicyList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(endpointpoliciesResource, endpointpoliciesKind, c.ns, opts), &v1alpha1.EndpointPolicyList{})
	...
	list := &v1alpha1.EndpointPolicyList{ListMeta: obj.(*v1alpha1.EndpointPolicyList).ListMeta}
	for _, item := range obj.(*v1alpha1.EndpointPolicyList).Items {
...
func (c *FakeEndpointPolicies) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(endpointpoliciesResource, c.ns, opts))
...
func (c *FakeEndpointPolicies) Create(ctx context.Context, endpointPolicy *v1alpha1.EndpointPolicy, opts v1.CreateOptions) (result *v1alpha1.EndpointPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(endpointpoliciesResource, c.ns, endpointPolicy), &v1alpha1.EndpointPolicy{})
...
func (c *FakeEndpointPolicies) Update(ctx context.Context, endpointPolicy *v1alpha1.EndpointPolicy, opts v1.UpdateOptions) (result *v1alpha1.EndpointPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(endpointpoliciesResource, c.ns, endpointPolicy), &v1alpha1.EndpointPolicy{})
...
func (c *FakeEndpointPolicies) UpdateStatus(ctx context.Context, endpointPolicy *v1alpha1.EndpointPolicy, opts v1.UpdateOptions) (*v1alpha1.EndpointPolicy, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(endpointpoliciesResource, "status", c.ns, endpointPolicy), &v1alpha1.EndpointPolicy{})
...
func (c *FakeEndpointPolicies) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(endpointpoliciesResource, c.ns, name), &v1alpha1.EndpointPolicy{})
...
func (c *FakeEndpointPolicies) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(endpointpoliciesResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.EndpointPolicyList{})
	return err
}
...
func (c *FakeEndpointPolicies) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EndpointPolicy, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(endpointpoliciesResource, c.ns, name, pt, data, subresources...), &v1alpha1.EndpointPolicy{})
