...
var endpointconnectionacceptersResource = schema.GroupVersionResource{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Resource: "endpointconnectionaccepters"}

var endpointconnectionacceptersKind = schema.GroupVersionKind{Group: "vpc.aws.kubeform.com", Version: "v1alpha1", Kind: "EndpointConnectionAccepter"}
...
func (c *FakeEndpointConnectionAccepters) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EndpointConnectionAccepter, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(endpointconnectionacceptersResource, c.ns, name), &v1alpha1.EndpointConnectionAccepter{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.EndpointConnectionAccepter), err
}
...
func (c *FakeEndpointConnectionAccepters) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EndpointConnectionAccepterList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(endpointconnectionacceptersResource, endpointconnectionacceptersKind, c.ns, opts), &v1alpha1.EndpointConnectionAccepterList{})
	...
	list := &v1alpha1.EndpointConnectionAccepterList{ListMeta: obj.(*v1alpha1.EndpointConnectionAccepterList).ListMeta}
	for _, item := range obj.(*v1alpha1.EndpointConnectionAccepterList).Items {
...
func (c *FakeEndpointConnectionAccepters) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(endpointconnectionacceptersResource, c.ns, opts))
...
func (c *FakeEndpointConnectionAccepters) Create(ctx context.Context, endpointConnectionAccepter *v1alpha1.EndpointConnectionAccepter, opts v1.CreateOptions) (result *v1alpha1.EndpointConnectionAccepter, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(endpointconnectionacceptersResource, c.ns, endpointConnectionAccepter), &v1alpha1.EndpointConnectionAccepter{})
...
func (c *FakeEndpointConnectionAccepters) Update(ctx context.Context, endpointConnectionAccepter *v1alpha1.EndpointConnectionAccepter, opts v1.UpdateOptions) (result *v1alpha1.EndpointConnectionAccepter, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(endpointconnectionacceptersResource, c.ns, endpointConnectionAccepter), &v1alpha1.EndpointConnectionAccepter{})
...
func (c *FakeEndpointConnectionAccepters) UpdateStatus(ctx context.Context, endpointConnectionAccepter *v1alpha1.EndpointConnectionAccepter, opts v1.UpdateOptions) (*v1alpha1.EndpointConnectionAccepter, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(endpointconnectionacceptersResource, "status", c.ns, endpointConnectionAccepter), &v1alpha1.EndpointConnectionAccepter{})
...
func (c *FakeEndpointConnectionAccepters) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(endpointconnectionacceptersResource, c.ns, name), &v1alpha1.EndpointConnectionAccepter{})
...
func (c *FakeEndpointConnectionAccepters) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(endpointconnectionacceptersResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.EndpointConnectionAccepterList{})
	return err
}
...
func (c *FakeEndpointConnectionAccepters) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EndpointConnectionAccepter, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(endpointconnectionacceptersResource, c.ns, name, pt, data, subresources...), &v1alpha1.EndpointConnectionAccepter{})
