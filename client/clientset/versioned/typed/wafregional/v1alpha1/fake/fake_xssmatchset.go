...
var xssmatchsetsResource = schema.GroupVersionResource{Group: "wafregional.aws.kubeform.com", Version: "v1alpha1", Resource: "xssmatchsets"}

var xssmatchsetsKind = schema.GroupVersionKind{Group: "wafregional.aws.kubeform.com", Version: "v1alpha1", Kind: "XssMatchSet"}
...
func (c *FakeXssMatchSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeXssMatchSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(xssmatchsetsResource, c.ns, listOpts)
