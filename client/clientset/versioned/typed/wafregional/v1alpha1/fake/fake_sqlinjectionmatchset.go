...
var sqlinjectionmatchsetsResource = schema.GroupVersionResource{Group: "wafregional.aws.kubeform.com", Version: "v1alpha1", Resource: "sqlinjectionmatchsets"}

var sqlinjectionmatchsetsKind = schema.GroupVersionKind{Group: "wafregional.aws.kubeform.com", Version: "v1alpha1", Kind: "SqlInjectionMatchSet"}
...
func (c *FakeSqlInjectionMatchSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SqlInjectionMatchSet, err error) {
	obj, err := c.Fake.
...
func (c *FakeSqlInjectionMatchSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SqlInjectionMatchSetList, err error) {
	obj, err := c.Fake.
...
func (c *FakeSqlInjectionMatchSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeSqlInjectionMatchSets) UpdateStatus(ctx context.Context, sqlInjectionMatchSet *v1alpha1.SqlInjectionMatchSet, opts v1.UpdateOptions) (*v1alpha1.SqlInjectionMatchSet, error) {
	obj, err := c.Fake.
...
func (c *FakeSqlInjectionMatchSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeSqlInjectionMatchSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(sqlinjectionmatchsetsResource, c.ns, listOpts)
