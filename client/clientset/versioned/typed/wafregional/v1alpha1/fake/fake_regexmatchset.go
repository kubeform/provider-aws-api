...
var regexmatchsetsResource = schema.GroupVersionResource{Group: "wafregional.aws.kubeform.com", Version: "v1alpha1", Resource: "regexmatchsets"}

var regexmatchsetsKind = schema.GroupVersionKind{Group: "wafregional.aws.kubeform.com", Version: "v1alpha1", Kind: "RegexMatchSet"}
...
func (c *FakeRegexMatchSets) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.RegexMatchSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(regexmatchsetsResource, c.ns, name), &v1alpha1.RegexMatchSet{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.RegexMatchSet), err
}
...
func (c *FakeRegexMatchSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.RegexMatchSetList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(regexmatchsetsResource, regexmatchsetsKind, c.ns, opts), &v1alpha1.RegexMatchSetList{})
	...
	list := &v1alpha1.RegexMatchSetList{ListMeta: obj.(*v1alpha1.RegexMatchSetList).ListMeta}
	for _, item := range obj.(*v1alpha1.RegexMatchSetList).Items {
...
func (c *FakeRegexMatchSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(regexmatchsetsResource, c.ns, opts))
...
func (c *FakeRegexMatchSets) Create(ctx context.Context, regexMatchSet *v1alpha1.RegexMatchSet, opts v1.CreateOptions) (result *v1alpha1.RegexMatchSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(regexmatchsetsResource, c.ns, regexMatchSet), &v1alpha1.RegexMatchSet{})
...
func (c *FakeRegexMatchSets) Update(ctx context.Context, regexMatchSet *v1alpha1.RegexMatchSet, opts v1.UpdateOptions) (result *v1alpha1.RegexMatchSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(regexmatchsetsResource, c.ns, regexMatchSet), &v1alpha1.RegexMatchSet{})
...
func (c *FakeRegexMatchSets) UpdateStatus(ctx context.Context, regexMatchSet *v1alpha1.RegexMatchSet, opts v1.UpdateOptions) (*v1alpha1.RegexMatchSet, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(regexmatchsetsResource, "status", c.ns, regexMatchSet), &v1alpha1.RegexMatchSet{})
...
func (c *FakeRegexMatchSets) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(regexmatchsetsResource, c.ns, name), &v1alpha1.RegexMatchSet{})
...
func (c *FakeRegexMatchSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(regexmatchsetsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.RegexMatchSetList{})
	return err
}
...
func (c *FakeRegexMatchSets) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.RegexMatchSet, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(regexmatchsetsResource, c.ns, name, pt, data, subresources...), &v1alpha1.RegexMatchSet{})
