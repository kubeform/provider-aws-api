...
var sizeconstraintsetsResource = schema.GroupVersionResource{Group: "wafregional.aws.kubeform.com", Version: "v1alpha1", Resource: "sizeconstraintsets"}

var sizeconstraintsetsKind = schema.GroupVersionKind{Group: "wafregional.aws.kubeform.com", Version: "v1alpha1", Kind: "SizeConstraintSet"}
...
func (c *FakeSizeConstraintSets) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SizeConstraintSetList, err error) {
	obj, err := c.Fake.
...
func (c *FakeSizeConstraintSets) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeSizeConstraintSets) UpdateStatus(ctx context.Context, sizeConstraintSet *v1alpha1.SizeConstraintSet, opts v1.UpdateOptions) (*v1alpha1.SizeConstraintSet, error) {
	obj, err := c.Fake.
...
func (c *FakeSizeConstraintSets) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(sizeconstraintsetsResource, c.ns, listOpts)
