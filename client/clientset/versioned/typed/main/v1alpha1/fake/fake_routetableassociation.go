...
type FakeRouteTableAssociations struct {
	Fake *FakeMainV1alpha1
	ns   string
}

var routetableassociationsResource = schema.GroupVersionResource{Group: "main.aws.kubeform.com", Version: "v1alpha1", Resource: "routetableassociations"}

var routetableassociationsKind = schema.GroupVersionKind{Group: "main.aws.kubeform.com", Version: "v1alpha1", Kind: "RouteTableAssociation"}
