...
type FakeGroupMemberships struct {
	Fake *FakeQuicksightV1alpha1
	ns   string
}

var groupmembershipsResource = schema.GroupVersionResource{Group: "quicksight.aws.kubeform.com", Version: "v1alpha1", Resource: "groupmemberships"}

var groupmembershipsKind = schema.GroupVersionKind{Group: "quicksight.aws.kubeform.com", Version: "v1alpha1", Kind: "GroupMembership"}
