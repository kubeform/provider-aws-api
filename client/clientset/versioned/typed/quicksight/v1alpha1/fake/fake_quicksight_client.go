...
import (
	...
	v1alpha1 "kubeform.dev/provider-aws-api/client/clientset/versioned/typed/quicksight/v1alpha1"
)

type FakeQuicksightV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeQuicksightV1alpha1) RESTClient() rest.Interface {
