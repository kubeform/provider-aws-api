...
var classifiersResource = schema.GroupVersionResource{Group: "glue.aws.kubeform.com", Version: "v1alpha1", Resource: "classifiers"}

var classifiersKind = schema.GroupVersionKind{Group: "glue.aws.kubeform.com", Version: "v1alpha1", Kind: "Classifier"}

// Get takes name of the classifier, and returns the corresponding classifier object, and an error if there is any.
func (c *FakeClassifiers) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Classifier, err error) {
	obj, err := c.Fake.
...
func (c *FakeClassifiers) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ClassifierList, err error) {
	obj, err := c.Fake.
...
func (c *FakeClassifiers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeClassifiers) Create(ctx context.Context, classifier *v1alpha1.Classifier, opts v1.CreateOptions) (result *v1alpha1.Classifier, err error) {
	obj, err := c.Fake.
...
func (c *FakeClassifiers) Update(ctx context.Context, classifier *v1alpha1.Classifier, opts v1.UpdateOptions) (result *v1alpha1.Classifier, err error) {
	obj, err := c.Fake.
...
func (c *FakeClassifiers) UpdateStatus(ctx context.Context, classifier *v1alpha1.Classifier, opts v1.UpdateOptions) (*v1alpha1.Classifier, error) {
	obj, err := c.Fake.
...
func (c *FakeClassifiers) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeClassifiers) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(classifiersResource, c.ns, listOpts)
...
func (c *FakeClassifiers) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Classifier, err error) {
	obj, err := c.Fake.
