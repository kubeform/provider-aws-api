...
import (
	v1alpha1 "kubeform.dev/provider-aws-api/client/clientset/versioned/typed/appautoscaling/v1alpha1"
...
func (c *FakeAppautoscalingV1alpha1) Policies(namespace string) v1alpha1.PolicyInterface {
...
func (c *FakeAppautoscalingV1alpha1) Targets(namespace string) v1alpha1.TargetInterface {
