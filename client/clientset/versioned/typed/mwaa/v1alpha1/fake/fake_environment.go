...
type FakeEnvironments struct {
	Fake *FakeMwaaV1alpha1
	ns   string
}

var environmentsResource = schema.GroupVersionResource{Group: "mwaa.aws.kubeform.com", Version: "v1alpha1", Resource: "environments"}

var environmentsKind = schema.GroupVersionKind{Group: "mwaa.aws.kubeform.com", Version: "v1alpha1", Kind: "Environment"}
