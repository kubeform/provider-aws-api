...
import (
	v1alpha1 "kubeform.dev/provider-aws-api/client/clientset/versioned/typed/appmesh/v1alpha1"
...
func (c *FakeAppmeshV1alpha1) GatewayRoutes(namespace string) v1alpha1.GatewayRouteInterface {
...
func (c *FakeAppmeshV1alpha1) VirtualGateways(namespace string) v1alpha1.VirtualGatewayInterface {
	return &FakeVirtualGateways{c, namespace}
}
