...
var virtualservicesResource = schema.GroupVersionResource{Group: "appmesh.aws.kubeform.com", Version: "v1alpha1", Resource: "virtualservices"}

var virtualservicesKind = schema.GroupVersionKind{Group: "appmesh.aws.kubeform.com", Version: "v1alpha1", Kind: "VirtualService"}

// Get takes name of the virtualService, and returns the corresponding virtualService object, and an error if there is any.
func (c *FakeVirtualServices) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.VirtualService, err error) {
	obj, err := c.Fake.
...
func (c *FakeVirtualServices) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.VirtualServiceList, err error) {
	obj, err := c.Fake.
...
func (c *FakeVirtualServices) Create(ctx context.Context, virtualService *v1alpha1.VirtualService, opts v1.CreateOptions) (result *v1alpha1.VirtualService, err error) {
	obj, err := c.Fake.
...
func (c *FakeVirtualServices) Update(ctx context.Context, virtualService *v1alpha1.VirtualService, opts v1.UpdateOptions) (result *v1alpha1.VirtualService, err error) {
	obj, err := c.Fake.
...
func (c *FakeVirtualServices) UpdateStatus(ctx context.Context, virtualService *v1alpha1.VirtualService, opts v1.UpdateOptions) (*v1alpha1.VirtualService, error) {
	obj, err := c.Fake.
...
func (c *FakeVirtualServices) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.VirtualService, err error) {
	obj, err := c.Fake.
