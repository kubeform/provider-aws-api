...
var scheduledactionsResource = schema.GroupVersionResource{Group: "redshift.aws.kubeform.com", Version: "v1alpha1", Resource: "scheduledactions"}

var scheduledactionsKind = schema.GroupVersionKind{Group: "redshift.aws.kubeform.com", Version: "v1alpha1", Kind: "ScheduledAction"}
...
func (c *FakeScheduledActions) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ScheduledActionList, err error) {
	obj, err := c.Fake.
...
func (c *FakeScheduledActions) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeScheduledActions) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(scheduledactionsResource, c.ns, listOpts)
