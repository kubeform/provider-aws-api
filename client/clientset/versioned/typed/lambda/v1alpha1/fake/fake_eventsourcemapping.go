...
var eventsourcemappingsResource = schema.GroupVersionResource{Group: "lambda.aws.kubeform.com", Version: "v1alpha1", Resource: "eventsourcemappings"}

var eventsourcemappingsKind = schema.GroupVersionKind{Group: "lambda.aws.kubeform.com", Version: "v1alpha1", Kind: "EventSourceMapping"}
...
func (c *FakeEventSourceMappings) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.EventSourceMapping, err error) {
	obj, err := c.Fake.
...
func (c *FakeEventSourceMappings) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.EventSourceMappingList, err error) {
	obj, err := c.Fake.
...
func (c *FakeEventSourceMappings) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeEventSourceMappings) Create(ctx context.Context, eventSourceMapping *v1alpha1.EventSourceMapping, opts v1.CreateOptions) (result *v1alpha1.EventSourceMapping, err error) {
	obj, err := c.Fake.
...
func (c *FakeEventSourceMappings) Update(ctx context.Context, eventSourceMapping *v1alpha1.EventSourceMapping, opts v1.UpdateOptions) (result *v1alpha1.EventSourceMapping, err error) {
	obj, err := c.Fake.
...
func (c *FakeEventSourceMappings) UpdateStatus(ctx context.Context, eventSourceMapping *v1alpha1.EventSourceMapping, opts v1.UpdateOptions) (*v1alpha1.EventSourceMapping, error) {
	obj, err := c.Fake.
...
func (c *FakeEventSourceMappings) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeEventSourceMappings) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(eventsourcemappingsResource, c.ns, listOpts)
...
func (c *FakeEventSourceMappings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.EventSourceMapping, err error) {
	obj, err := c.Fake.
