...
import (
	v1alpha1 "kubeform.dev/provider-aws-api/client/clientset/versioned/typed/lambda/v1alpha1"
...
func (c *FakeLambdaV1alpha1) CodeSigningConfigs(namespace string) v1alpha1.CodeSigningConfigInterface {
	return &FakeCodeSigningConfigs{c, namespace}
}
...
func (c *FakeLambdaV1alpha1) FunctionEventInvokeConfigs(namespace string) v1alpha1.FunctionEventInvokeConfigInterface {
...
func (c *FakeLambdaV1alpha1) ProvisionedConcurrencyConfigs(namespace string) v1alpha1.ProvisionedConcurrencyConfigInterface {
	return &FakeProvisionedConcurrencyConfigs{c, namespace}
}
