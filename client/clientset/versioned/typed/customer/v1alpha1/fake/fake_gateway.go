...
type FakeGateways struct {
	Fake *FakeCustomerV1alpha1
	ns   string
}

var gatewaysResource = schema.GroupVersionResource{Group: "customer.aws.kubeform.com", Version: "v1alpha1", Resource: "gateways"}

var gatewaysKind = schema.GroupVersionKind{Group: "customer.aws.kubeform.com", Version: "v1alpha1", Kind: "Gateway"}
