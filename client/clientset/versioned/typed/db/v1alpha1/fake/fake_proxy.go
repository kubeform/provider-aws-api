...
var proxiesResource = schema.GroupVersionResource{Group: "db.aws.kubeform.com", Version: "v1alpha1", Resource: "proxies"}

var proxiesKind = schema.GroupVersionKind{Group: "db.aws.kubeform.com", Version: "v1alpha1", Kind: "Proxy"}
