...
var instancesResource = schema.GroupVersionResource{Group: "db.aws.kubeform.com", Version: "v1alpha1", Resource: "instances"}

var instancesKind = schema.GroupVersionKind{Group: "db.aws.kubeform.com", Version: "v1alpha1", Kind: "Instance"}
