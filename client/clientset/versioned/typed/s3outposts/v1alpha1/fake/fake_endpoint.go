...
type FakeEndpoints struct {
	Fake *FakeS3outpostsV1alpha1
	ns   string
}

var endpointsResource = schema.GroupVersionResource{Group: "s3outposts.aws.kubeform.com", Version: "v1alpha1", Resource: "endpoints"}

var endpointsKind = schema.GroupVersionKind{Group: "s3outposts.aws.kubeform.com", Version: "v1alpha1", Kind: "Endpoint"}
