...
type FakeGroups struct {
	Fake *FakeResourcegroupsV1alpha1
	ns   string
}

var groupsResource = schema.GroupVersionResource{Group: "resourcegroups.aws.kubeform.com", Version: "v1alpha1", Resource: "groups"}

var groupsKind = schema.GroupVersionKind{Group: "resourcegroups.aws.kubeform.com", Version: "v1alpha1", Kind: "Group"}
