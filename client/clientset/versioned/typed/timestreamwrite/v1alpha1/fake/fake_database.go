...
type FakeDatabases struct {
	Fake *FakeTimestreamwriteV1alpha1
	ns   string
}

var databasesResource = schema.GroupVersionResource{Group: "timestreamwrite.aws.kubeform.com", Version: "v1alpha1", Resource: "databases"}

var databasesKind = schema.GroupVersionKind{Group: "timestreamwrite.aws.kubeform.com", Version: "v1alpha1", Kind: "Database"}
