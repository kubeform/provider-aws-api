...
type FakeGlacierVaults struct {
	Fake *FakeGlaciervaultV1alpha1
	ns   string
}

var glaciervaultsResource = schema.GroupVersionResource{Group: "glaciervault.aws.kubeform.com", Version: "v1alpha1", Resource: "glaciervaults"}

var glaciervaultsKind = schema.GroupVersionKind{Group: "glaciervault.aws.kubeform.com", Version: "v1alpha1", Kind: "GlacierVault"}
