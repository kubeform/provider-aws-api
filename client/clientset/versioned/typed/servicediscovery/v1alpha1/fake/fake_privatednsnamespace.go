...
var privatednsnamespacesResource = schema.GroupVersionResource{Group: "servicediscovery.aws.kubeform.com", Version: "v1alpha1", Resource: "privatednsnamespaces"}

var privatednsnamespacesKind = schema.GroupVersionKind{Group: "servicediscovery.aws.kubeform.com", Version: "v1alpha1", Kind: "PrivateDNSNamespace"}
...
func (c *FakePrivateDNSNamespaces) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.PrivateDNSNamespace, err error) {
	obj, err := c.Fake.
...
func (c *FakePrivateDNSNamespaces) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.PrivateDNSNamespaceList, err error) {
	obj, err := c.Fake.
...
func (c *FakePrivateDNSNamespaces) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakePrivateDNSNamespaces) Create(ctx context.Context, privateDNSNamespace *v1alpha1.PrivateDNSNamespace, opts v1.CreateOptions) (result *v1alpha1.PrivateDNSNamespace, err error) {
	obj, err := c.Fake.
...
func (c *FakePrivateDNSNamespaces) Update(ctx context.Context, privateDNSNamespace *v1alpha1.PrivateDNSNamespace, opts v1.UpdateOptions) (result *v1alpha1.PrivateDNSNamespace, err error) {
	obj, err := c.Fake.
...
func (c *FakePrivateDNSNamespaces) UpdateStatus(ctx context.Context, privateDNSNamespace *v1alpha1.PrivateDNSNamespace, opts v1.UpdateOptions) (*v1alpha1.PrivateDNSNamespace, error) {
	obj, err := c.Fake.
...
func (c *FakePrivateDNSNamespaces) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakePrivateDNSNamespaces) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(privatednsnamespacesResource, c.ns, listOpts)
...
func (c *FakePrivateDNSNamespaces) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.PrivateDNSNamespace, err error) {
	obj, err := c.Fake.
