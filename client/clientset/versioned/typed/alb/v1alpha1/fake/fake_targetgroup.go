...
var targetgroupsResource = schema.GroupVersionResource{Group: "alb.aws.kubeform.com", Version: "v1alpha1", Resource: "targetgroups"}

var targetgroupsKind = schema.GroupVersionKind{Group: "alb.aws.kubeform.com", Version: "v1alpha1", Kind: "TargetGroup"}
...
func (c *FakeTargetGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(targetgroupsResource, c.ns, listOpts)
