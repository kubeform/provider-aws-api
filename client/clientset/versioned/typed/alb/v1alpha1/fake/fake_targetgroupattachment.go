...
var targetgroupattachmentsResource = schema.GroupVersionResource{Group: "alb.aws.kubeform.com", Version: "v1alpha1", Resource: "targetgroupattachments"}

var targetgroupattachmentsKind = schema.GroupVersionKind{Group: "alb.aws.kubeform.com", Version: "v1alpha1", Kind: "TargetGroupAttachment"}
...
func (c *FakeTargetGroupAttachments) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.TargetGroupAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(targetgroupattachmentsResource, c.ns, name), &v1alpha1.TargetGroupAttachment{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha1.TargetGroupAttachment), err
}
...
func (c *FakeTargetGroupAttachments) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.TargetGroupAttachmentList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(targetgroupattachmentsResource, targetgroupattachmentsKind, c.ns, opts), &v1alpha1.TargetGroupAttachmentList{})
	...
	list := &v1alpha1.TargetGroupAttachmentList{ListMeta: obj.(*v1alpha1.TargetGroupAttachmentList).ListMeta}
	for _, item := range obj.(*v1alpha1.TargetGroupAttachmentList).Items {
...
func (c *FakeTargetGroupAttachments) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(targetgroupattachmentsResource, c.ns, opts))
...
func (c *FakeTargetGroupAttachments) Create(ctx context.Context, targetGroupAttachment *v1alpha1.TargetGroupAttachment, opts v1.CreateOptions) (result *v1alpha1.TargetGroupAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(targetgroupattachmentsResource, c.ns, targetGroupAttachment), &v1alpha1.TargetGroupAttachment{})
...
func (c *FakeTargetGroupAttachments) Update(ctx context.Context, targetGroupAttachment *v1alpha1.TargetGroupAttachment, opts v1.UpdateOptions) (result *v1alpha1.TargetGroupAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(targetgroupattachmentsResource, c.ns, targetGroupAttachment), &v1alpha1.TargetGroupAttachment{})
...
func (c *FakeTargetGroupAttachments) UpdateStatus(ctx context.Context, targetGroupAttachment *v1alpha1.TargetGroupAttachment, opts v1.UpdateOptions) (*v1alpha1.TargetGroupAttachment, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(targetgroupattachmentsResource, "status", c.ns, targetGroupAttachment), &v1alpha1.TargetGroupAttachment{})
...
func (c *FakeTargetGroupAttachments) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(targetgroupattachmentsResource, c.ns, name), &v1alpha1.TargetGroupAttachment{})
...
func (c *FakeTargetGroupAttachments) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(targetgroupattachmentsResource, c.ns, listOpts)

	_, err := c.Fake.Invokes(action, &v1alpha1.TargetGroupAttachmentList{})
	return err
}
...
func (c *FakeTargetGroupAttachments) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.TargetGroupAttachment, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(targetgroupattachmentsResource, c.ns, name, pt, data, subresources...), &v1alpha1.TargetGroupAttachment{})
