...
var replicationsubnetgroupsResource = schema.GroupVersionResource{Group: "dms.aws.kubeform.com", Version: "v1alpha1", Resource: "replicationsubnetgroups"}

var replicationsubnetgroupsKind = schema.GroupVersionKind{Group: "dms.aws.kubeform.com", Version: "v1alpha1", Kind: "ReplicationSubnetGroup"}
...
func (c *FakeReplicationSubnetGroups) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.ReplicationSubnetGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicationSubnetGroups) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.ReplicationSubnetGroupList, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicationSubnetGroups) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeReplicationSubnetGroups) Create(ctx context.Context, replicationSubnetGroup *v1alpha1.ReplicationSubnetGroup, opts v1.CreateOptions) (result *v1alpha1.ReplicationSubnetGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicationSubnetGroups) Update(ctx context.Context, replicationSubnetGroup *v1alpha1.ReplicationSubnetGroup, opts v1.UpdateOptions) (result *v1alpha1.ReplicationSubnetGroup, err error) {
	obj, err := c.Fake.
...
func (c *FakeReplicationSubnetGroups) UpdateStatus(ctx context.Context, replicationSubnetGroup *v1alpha1.ReplicationSubnetGroup, opts v1.UpdateOptions) (*v1alpha1.ReplicationSubnetGroup, error) {
	obj, err := c.Fake.
...
func (c *FakeReplicationSubnetGroups) Delete(ctx context.Context, name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakeReplicationSubnetGroups) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(replicationsubnetgroupsResource, c.ns, listOpts)
...
func (c *FakeReplicationSubnetGroups) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.ReplicationSubnetGroup, err error) {
	obj, err := c.Fake.
