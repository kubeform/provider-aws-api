...
import (
	v1alpha1 "kubeform.dev/provider-aws-api/client/clientset/versioned/typed/ecrpublic/v1alpha1"

	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeEcrpublicV1alpha1 struct {
	*testing.Fake
}

func (c *FakeEcrpublicV1alpha1) Repositories(namespace string) v1alpha1.RepositoryInterface {
