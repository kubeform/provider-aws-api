...
type FakeConnections struct {
	Fake *FakeCodestarconnectionsV1alpha1
	ns   string
}

var connectionsResource = schema.GroupVersionResource{Group: "codestarconnections.aws.kubeform.com", Version: "v1alpha1", Resource: "connections"}

var connectionsKind = schema.GroupVersionKind{Group: "codestarconnections.aws.kubeform.com", Version: "v1alpha1", Kind: "Connection"}
