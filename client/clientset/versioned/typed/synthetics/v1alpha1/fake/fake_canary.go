...
var canariesResource = schema.GroupVersionResource{Group: "synthetics.aws.kubeform.com", Version: "v1alpha1", Resource: "canaries"}

var canariesKind = schema.GroupVersionKind{Group: "synthetics.aws.kubeform.com", Version: "v1alpha1", Kind: "Canary"}

// Get takes name of the canary, and returns the corresponding canary object, and an error if there is any.
func (c *FakeCanaries) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.Canary, err error) {
	obj, err := c.Fake.
...
func (c *FakeCanaries) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.CanaryList, err error) {
	obj, err := c.Fake.
...
func (c *FakeCanaries) Create(ctx context.Context, canary *v1alpha1.Canary, opts v1.CreateOptions) (result *v1alpha1.Canary, err error) {
	obj, err := c.Fake.
...
func (c *FakeCanaries) Update(ctx context.Context, canary *v1alpha1.Canary, opts v1.UpdateOptions) (result *v1alpha1.Canary, err error) {
	obj, err := c.Fake.
...
func (c *FakeCanaries) UpdateStatus(ctx context.Context, canary *v1alpha1.Canary, opts v1.UpdateOptions) (*v1alpha1.Canary, error) {
	obj, err := c.Fake.
...
func (c *FakeCanaries) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Canary, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(canariesResource, c.ns, name, pt, data, subresources...), &v1alpha1.Canary{})
