...
var userpoolclientsResource = schema.GroupVersionResource{Group: "cognito.aws.kubeform.com", Version: "v1alpha1", Resource: "userpoolclients"}

var userpoolclientsKind = schema.GroupVersionKind{Group: "cognito.aws.kubeform.com", Version: "v1alpha1", Kind: "UserPoolClient"}
...
func (c *FakeUserPoolClients) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.UserPoolClientList, err error) {
	obj, err := c.Fake.
...
func (c *FakeUserPoolClients) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeUserPoolClients) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(userpoolclientsResource, c.ns, listOpts)
