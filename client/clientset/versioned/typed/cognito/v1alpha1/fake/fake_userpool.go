...
var userpoolsResource = schema.GroupVersionResource{Group: "cognito.aws.kubeform.com", Version: "v1alpha1", Resource: "userpools"}

var userpoolsKind = schema.GroupVersionKind{Group: "cognito.aws.kubeform.com", Version: "v1alpha1", Kind: "UserPool"}
...
func (c *FakeUserPools) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeUserPools) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(userpoolsResource, c.ns, listOpts)
