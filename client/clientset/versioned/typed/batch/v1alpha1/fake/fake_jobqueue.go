...
var jobqueuesResource = schema.GroupVersionResource{Group: "batch.aws.kubeform.com", Version: "v1alpha1", Resource: "jobqueues"}

var jobqueuesKind = schema.GroupVersionKind{Group: "batch.aws.kubeform.com", Version: "v1alpha1", Kind: "JobQueue"}
...
func (c *FakeJobQueues) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
...
func (c *FakeJobQueues) DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(jobqueuesResource, c.ns, listOpts)
