...
var routesResource = schema.GroupVersionResource{Group: "route.aws.kubeform.com", Version: "v1alpha1", Resource: "routes"}

var routesKind = schema.GroupVersionKind{Group: "route.aws.kubeform.com", Version: "v1alpha1", Kind: "Route"}
