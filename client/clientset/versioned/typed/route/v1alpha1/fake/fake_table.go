...
var tablesResource = schema.GroupVersionResource{Group: "route.aws.kubeform.com", Version: "v1alpha1", Resource: "tables"}

var tablesKind = schema.GroupVersionKind{Group: "route.aws.kubeform.com", Version: "v1alpha1", Kind: "Table"}
