...
import (
	...
	v1alpha1 "kubeform.dev/provider-aws-api/client/clientset/versioned/typed/route/v1alpha1"
)
...
func (c *FakeRouteV1alpha1) TableAssociations(namespace string) v1alpha1.TableAssociationInterface {
	return &FakeTableAssociations{c, namespace}
}
