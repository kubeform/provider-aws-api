...
// codepipelineLister implements the CodepipelineLister interface.
type codepipelineLister struct {
...
func NewCodepipelineLister(indexer cache.Indexer) CodepipelineLister {
	return &codepipelineLister{indexer: indexer}
}

// List lists all Codepipelines in the indexer.
func (s *codepipelineLister) List(selector labels.Selector) (ret []*v1alpha1.Codepipeline, err error) {
...
func (s codepipelineNamespaceLister) Get(name string) (*v1alpha1.Codepipeline, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("codepipeline"), name)
	}
	return obj.(*v1alpha1.Codepipeline), nil
}
