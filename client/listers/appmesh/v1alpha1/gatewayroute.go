...
// List lists all GatewayRoutes in the indexer.
func (s *gatewayRouteLister) List(selector labels.Selector) (ret []*v1alpha1.GatewayRoute, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1alpha1.GatewayRoute))
	})
	return ret, err
}
...
// List lists all GatewayRoutes in the indexer for a given namespace.
func (s gatewayRouteNamespaceLister) List(selector labels.Selector) (ret []*v1alpha1.GatewayRoute, err error) {
...
// Get retrieves the GatewayRoute from the indexer for a given namespace and name.
func (s gatewayRouteNamespaceLister) Get(name string) (*v1alpha1.GatewayRoute, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1alpha1.Resource("gatewayroute"), name)
	}
	return obj.(*v1alpha1.GatewayRoute), nil
}
